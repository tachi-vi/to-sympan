...
// helper: compute accelerations for arrays of positions and masses
...
// optional: move bodies to center-of-mass frame (helps numerical behavior)
...
// safer RK4 using temporary arrays, no in-place stage mutation
...
}// --- helper: convert bodies <-> state vector
...
// --- compute dy/dt for the whole state (positions -> velocities, velocities -> accelerations)
...
// --- RK45 (Dormand-Prince) single step with adaptive error estimate
...
// --- wrapper: advance bodies by exactly dtTarget using adaptive substeps
